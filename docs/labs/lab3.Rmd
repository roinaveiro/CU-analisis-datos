...
¿Cuántas observaciones hay en el dataset para cada género? ¿Qué proporcón de mujeres son fumadoras? ¿Y de hombres?
...
*Nota*: Crea una nueva variable llamada `decada` utilizando la función `cut`.
