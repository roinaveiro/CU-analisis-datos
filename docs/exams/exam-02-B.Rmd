---
title: "Segundo Parcial - Modelo B"
...
* Utilizando únicamente los datos posteriores al año 2015, calcula el desempleo **medio**.  Crea un gráfico de barras cuyo eje x corresponda a la variable `mes` y el eje y contenga el desempleo medio. ¿Qué mes tiene mayor tasa de desempleo media? ¿Sabrías explicar por qué?
...
* ¿Cuál es la edad mediana de los pacientes?

* ¿Cuántos pacientes en la segunda base de datos tienen más de 8 miligramos del compuesto en sangre?
...
* Para los pacientes que SÍ tienen resultados del análisis ¿cuál es la media de cantidad de compuesto en sangre de aquellos mayores de 50 años?
