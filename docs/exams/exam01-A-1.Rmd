...
¿Cuáles fueron las tres horas del día en las que existen menos vuelos? Haz una tabla 
en la que aparezca **únicamente** las **tres** horas con menos vuelos en orden
**ascendente** de número de vuelos y muestre también la cantidad de vuelos que 
despegaron durante esas horas. (Ten en cuenta que las horas están escritas en 
formato de 24 horas, por ejemplo, `hour` = 14 son las 2 p. m.).
...
son las cuatro combinaciones de aeropuertos de origen y destino más comunes?
Presenta los resultados en términos de la proporción sobre el total de vuelos que
aparecen en los datos. Para las cuatro combinaciones más comunes, 
muestra **únicamente** el aeropuerto de origen, el aeropuerto de destino
...
en el aire: ¿Los vuelos a qué aeropuerto tienen la mediana de tiempo en el aire
más alta? ¿Cuańto vale esta mediana? ¿Es esperable este resultado?
...
* Pista 2: AA y B6 son dos aerolíneas. JFK y LGA son los aeropuertos de origen.
