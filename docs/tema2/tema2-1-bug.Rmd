...
- **Variables categóricas**, a su vez incluyen **ordinales** si existe un orden natural
entre sus niveles o **no ordinales**
    - *color de ojos*  es ?
...
```{r quartet-plot, out.width = "55%", fig.align = "center"}
...
```{r out.width = "50%", fig.align='center', fig.width=5, fig.height=3}
ggplot(data = diamonds) + 
  stat_summary( #<<
